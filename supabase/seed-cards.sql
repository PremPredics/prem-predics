...
with cards (id, name, category, deck_type, effect_key, description) as (
  values
    ...
    ('curse_random_roulette', 'Curse of the Random Roulette', 'curse', 'regular', 'curse_random_roulette', 'Valid for 1 Gameweek. Opponent Star Man squad number is chosen by roulette from 1 to 36. Must be played at least 24 hours before the gameweek''s first KO time.'),
