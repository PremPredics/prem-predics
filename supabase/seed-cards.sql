...
with cards (id, name, category, deck_type, effect_key, description) as (
  values
    ...
    ('curse_random_roulette', 'Curse Of The Microstate', 'curse', 'regular', 'curse_random_roulette', 'Valid for 1 Gameweek. Opponent Star Man nationality must be from a Country with a population up to 5 million. Must be played at least 24 hours before the gameweek''s first KO time.'),
