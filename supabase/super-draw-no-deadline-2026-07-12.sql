-- Super Draw no-deadline patch.
-- Run once in Supabase SQL Editor so live card plays match the website/app rule.
-- Super Draw remains blocked before a private league's first week has ended,
-- but has no 90-minute gameweek card-play deadline after that.
