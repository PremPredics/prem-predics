-- Super Sub: update wording, allow post-deadline Super Sub saves, and score
-- Super Sub Star Men without yellow/red deductions or curse_furious deductions.
--
-- Run this once in Supabase SQL Editor after deploying the website/app files.

begin;

update public.card_definitions
set description = 'Star Man can be swapped at any time for any other Star Man whose first game in the Gameweek has not kicked-off. Yellow Cards and Red Cards don''t earn negative points. Curse Cards don''t apply on the Super Sub, Power Cards Apply.'
where id = 'super_sub';
