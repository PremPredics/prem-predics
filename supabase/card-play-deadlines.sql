...
with canonical_card_descriptions (id, description) as (
  values
    ...
    ('power_swap', 'Discard this card and one other unused card from your hand, then Draw 3 cards from the Regular Deck and pick 2 to keep in your hand. It cannot be played unless that other unused card is available.'),
    ...
    ('curse_random_roulette', 'Valid for 1 Gameweek. Opponent''s Star Man''s nationality must be from a Country with a population up to 10 million. Must be played at least 24 hours before the gameweek''s first KO time.'),
    ...
    ('super_star_man', 'Can only be played after you have saved a Star Man for this Gameweek. Star Man points are TRIPLED. Yellow and Red cards are 0pts. Duration: 1 Gameweek for 2-3 player leagues, 2 Gameweeks for 4-6, and 3 Gameweeks for 7-10.'),
    ...
    ('super_draw', 'Draw 5 Regular Cards from the Regular Deck.'),
