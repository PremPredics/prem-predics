...
with canonical_card_descriptions (id, description) as (
  values
    ...
    ('curse_random_roulette', 'Valid for 1 Gameweek. Opponent''s Star Man''s nationality must be from a Country with a population up to 5 million. Must be played at least 24 hours before the gameweek''s first KO time.'),
