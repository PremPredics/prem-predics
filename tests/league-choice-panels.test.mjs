...
test('League Hub reference accents and destination navigation are streamlined', () => {
  ...
  assert.match(leagueHtml, /league\.js\?v=20260901-vetoed-v1/);
  ...
  assert.match(serviceWorker, /prem-predics-pwa-v71/);
  assert.match(serviceWorker, /league\.js\?v=20260901-vetoed-v1/);
});
